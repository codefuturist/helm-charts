...
![AppVersion: 2.10.32](https://img.shields.io/badge/AppVersion-2.10.32-informational?style=flat-square)
...
helm repo update
helm install my-semaphore pandia/semaphore
```
...
<tr id="value-env" class="value-anchor" data-section="general">
