...
![AppVersion: 2.70.1](https://img.shields.io/badge/AppVersion-2.70.1-informational?style=flat-square)
...
helm repo update
helm install my-redisinsight pandia/redisinsight
```
...
<div class="filter-buttons">
  ...
  <button class="filter-btn" data-section="redis-insight-configuration">Redis Insight Configuration</button>
...
<tr class="values-section-header"><td colspan="4"><strong>Redis Insight Configuration</strong></td></tr>
<tr id="value-port" class="value-anchor" data-section="redis-insight-configuration">
<td><code class="value-key">port</code></td>
<td><span class="type-badge int">int</span></td>
<td><code>5540</code></td>
<td>Application port that Redis Insight listens on</td>
</tr>
<tr id="value-host" class="value-anchor" data-section="redis-insight-configuration">
<td><code class="value-key">host</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>"0.0.0.0"</code></td>
<td>Application host that Redis Insight binds to</td>
</tr>
<tr id="value-logLevel" class="value-anchor" data-section="redis-insight-configuration">
<td><code class="value-key">logLevel</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>"info"</code></td>
<td>Log level for the application</td>
</tr>
<tr id="value-filesLogger" class="value-anchor" data-section="redis-insight-configuration">
<td><code class="value-key">filesLogger</code></td>
<td><span class="type-badge bool">bool</span></td>
<td><code>true</code></td>
<td>Enable file logging</td>
</tr>
<tr id="value-stdoutLogger" class="value-anchor" data-section="redis-insight-configuration">
<td><code class="value-key">stdoutLogger</code></td>
<td><span class="type-badge bool">bool</span></td>
<td><code>true</code></td>
<td>Enable stdout logging</td>
</tr>
<tr id="value-proxyPath" class="value-anchor" data-section="redis-insight-configuration">
<td><code class="value-key">proxyPath</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>""</code></td>
<td>Proxy path for reverse proxy subdirectory hosting</td>
</tr>
<tr id="value-databaseManagement" class="value-anchor" data-section="redis-insight-configuration">
<td><code class="value-key">databaseManagement</code></td>
<td><span class="type-badge bool">bool</span></td>
<td><code>true</code></td>
<td>Enable/disable database connection management</td>
</tr>
<tr id="value-encryptionKey" class="value-anchor" data-section="redis-insight-configuration">
<td><code class="value-key">encryptionKey</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>""</code></td>
<td>Encryption key for sensitive data</td>
</tr>
<tr id="value-existingEncryptionKeySecret" class="value-anchor" data-section="redis-insight-configuration">
...
<tr id="value-existingEncryptionKeySecretKey" class="value-anchor" data-section="redis-insight-configuration">
...
<tr id="value-tls" class="value-anchor" data-section="redis-insight-configuration">
<td><code class="value-key">tls</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>`nil`</code></td>
<td>TLS/SSL configuration for HTTPS</td>
</tr>
<tr id="value-enabled" class="value-anchor" data-section="redis-insight-configuration">
<td><code class="value-key">enabled</code></td>
<td><span class="type-badge bool">bool</span></td>
<td><code>false</code></td>
<td>Enable TLS/SSL</td>
</tr>
<tr id="value-key" class="value-anchor" data-section="redis-insight-configuration">
<td><code class="value-key">key</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>""</code></td>
<td>TLS private key (PEM format)</td>
</tr>
<tr id="value-cert" class="value-anchor" data-section="redis-insight-configuration">
<td><code class="value-key">cert</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>""</code></td>
<td>TLS certificate (PEM format)</td>
</tr>
<tr id="value-existingSecret" class="value-anchor" data-section="redis-insight-configuration">
<td><code class="value-key">existingSecret</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>""</code></td>
<td>Name of an existing secret containing TLS key and cert</td>
</tr>
<tr id="value-existingSecretKeyKey" class="value-anchor" data-section="redis-insight-configuration">
...
<tr id="value-existingSecretCertKey" class="value-anchor" data-section="redis-insight-configuration">
...
<tr id="value-connections" class="value-anchor" data-section="redis-insight-configuration">
<td><code class="value-key">connections</code></td>
<td><span class="type-badge list">list</span></td>
<td><code>[]</code></td>
<td>Pre-configured Redis database connections</td>
</tr>
<tr id="value-existingConnectionPasswordsSecret" class="value-anchor" data-section="redis-insight-configuration">
