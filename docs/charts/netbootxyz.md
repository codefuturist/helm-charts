...
![AppVersion: 0.7.6-nbxyz10](https://img.shields.io/badge/AppVersion-0.7.6--nbxyz10-informational?style=flat-square)
...
helm repo update
helm install my-netbootxyz pandia/netbootxyz
```
