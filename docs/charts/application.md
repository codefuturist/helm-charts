...
![Version: 6.14.1](https://img.shields.io/badge/Version-6.14.1-informational?style=flat-square)
...
helm repo update
helm install my-application pandia/application
```
...
<div class="filter-buttons">
  ...
  <button class="filter-btn" data-section="httproute-parameters">HTTPRoute Parameters</button>
...
<tr id="value-includedNamespaces" class="value-anchor" data-section="backup-parameters">
...
<tr id="value-runtimeClassName" class="value-anchor" data-section="deployment-parameters">
...
<tr id="value-dnsPolicy" class="value-anchor" data-section="deployment-parameters">
...
<tr id="value-minReadySeconds" class="value-anchor" data-section="deployment-parameters">
...
<tr class="values-section-header"><td colspan="4"><strong>HTTPRoute Parameters</strong></td></tr>
<tr id="value-enabled" class="value-anchor" data-section="httproute-parameters">
<td><code class="value-key">enabled</code></td>
<td><span class="type-badge bool">bool</span></td>
<td><code>false</code></td>
<td>Enable HTTPRoute (Gateway API).</td>
</tr>
<tr id="value-parentRefs" class="value-anchor" data-section="httproute-parameters">
<td><code class="value-key">parentRefs</code></td>
<td><span class="type-badge tpl">tpl/list</span></td>
<td><code>`nil`</code></td>
<td>Parent references for the HTTPRoute.</td>
</tr>
<tr id="value-useDefaultGateways" class="value-anchor" data-section="httproute-parameters">
<td><code class="value-key">useDefaultGateways</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>`nil`</code></td>
<td>The default Gateway scope to use for this Route.</td>
</tr>
<tr id="value-gatewayNamespace" class="value-anchor" data-section="httproute-parameters">
<td><code class="value-key">gatewayNamespace</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>""</code></td>
<td>Namespace of the Gateway to attach this HTTPRoute to.</td>
</tr>
<tr id="value-hostnames" class="value-anchor" data-section="httproute-parameters">
<td><code class="value-key">hostnames</code></td>
<td><span class="type-badge tpl">tpl/list</span></td>
<td><code>`nil`</code></td>
<td>Hostnames for the HTTPRoute.</td>
</tr>
<tr id="value-additionalLabels" class="value-anchor" data-section="httproute-parameters">
<td><code class="value-key">additionalLabels</code></td>
<td><span class="type-badge object">object</span></td>
<td><code>{}</code></td>
<td>Additional labels for HTTPRoute.</td>
</tr>
<tr id="value-annotations" class="value-anchor" data-section="httproute-parameters">
<td><code class="value-key">annotations</code></td>
<td><span class="type-badge object">object</span></td>
<td><code>{}</code></td>
<td>Annotations for HTTPRoute.</td>
</tr>
<tr id="value-rules" class="value-anchor" data-section="httproute-parameters">
...
<tr id="value-additionalLabels" class="value-anchor" data-section="parameters">
<td><code class="value-key">additionalLabels</code></td>
<td><span class="type-badge tpl">tpl/object</span></td>
<td><code>`nil`</code></td>
<td>Additional labels for all resources.</td>
</tr>
<tr id="value-extraObjects" class="value-anchor" data-section="parameters">
...
<tr id="value-loadBalancerClass" class="value-anchor" data-section="service-parameters">
