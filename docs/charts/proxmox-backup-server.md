...
<div class="filter-buttons">
  ...
  <button class="filter-btn" data-section="proxmox-backup-server-configuration">Proxmox Backup Server Configuration</button>
...
<tr id="value-etc" class="value-anchor" data-section="persistence-configuration">
<td><code class="value-key">etc</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>`nil`</code></td>
<td>Persist /etc/proxmox-backup directory (configuration)</td>
</tr>
<tr id="value-logs" class="value-anchor" data-section="persistence-configuration">
<td><code class="value-key">logs</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>`nil`</code></td>
<td>Persist /var/log/proxmox-backup directory (logs)</td>
</tr>
<tr id="value-lib" class="value-anchor" data-section="persistence-configuration">
...
<tr class="values-section-header"><td colspan="4"><strong>Proxmox Backup Server Configuration</strong></td></tr>
<tr id="value-username" class="value-anchor" data-section="proxmox-backup-server-configuration">
<td><code class="value-key">username</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>"admin@pbs"</code></td>
<td>Default PBS login username</td>
</tr>
<tr id="value-password" class="value-anchor" data-section="proxmox-backup-server-configuration">
...
<tr id="value-existingSecret" class="value-anchor" data-section="proxmox-backup-server-configuration">
<td><code class="value-key">existingSecret</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>""</code></td>
<td>Name of an existing secret containing PBS credentials</td>
</tr>
<tr id="value-existingSecretUsernameKey" class="value-anchor" data-section="proxmox-backup-server-configuration">
<td><code class="value-key">existingSecretUsernameKey</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>"username"</code></td>
<td>Key in existingSecret that contains the username</td>
</tr>
<tr id="value-existingSecretPasswordKey" class="value-anchor" data-section="proxmox-backup-server-configuration">
<td><code class="value-key">existingSecretPasswordKey</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>"password"</code></td>
<td>Key in existingSecret that contains the password</td>
</tr>
<tr id="value-timezone" class="value-anchor" data-section="proxmox-backup-server-configuration">
<td><code class="value-key">timezone</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>"UTC"</code></td>
<td>Timezone configuration</td>
</tr>
<tr id="value-smartAccess" class="value-anchor" data-section="proxmox-backup-server-configuration">
<td><code class="value-key">smartAccess</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>`nil`</code></td>
<td>Enable SMART device access</td>
</tr>
<tr id="value-devices" class="value-anchor" data-section="proxmox-backup-server-configuration">
<td><code class="value-key">devices</code></td>
<td><span class="type-badge list">list</span></td>
<td><code>[]</code></td>
<td>List of device paths to expose to the container</td>
</tr>
<tr id="value-backupVolumes" class="value-anchor" data-section="proxmox-backup-server-configuration">
