...
<div class="filter-buttons">
  ...
  <button class="filter-btn" data-section="pgadmin-configuration">pgAdmin Configuration</button>
...
<tr class="values-section-header"><td colspan="4"><strong>pgAdmin Configuration</strong></td></tr>
<tr id="value-email" class="value-anchor" data-section="pgadmin-configuration">
...
<tr id="value-password" class="value-anchor" data-section="pgadmin-configuration">
...
<tr id="value-scriptName" class="value-anchor" data-section="pgadmin-configuration">
<td><code class="value-key">scriptName</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>""</code></td>
<td>Script name for reverse proxy subdirectory hosting</td>
</tr>
<tr id="value-gunicorn" class="value-anchor" data-section="pgadmin-configuration">
<td><code class="value-key">gunicorn</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>`nil`</code></td>
<td>Gunicorn configuration</td>
</tr>
<tr id="value-threads" class="value-anchor" data-section="pgadmin-configuration">
<td><code class="value-key">threads</code></td>
<td><span class="type-badge int">int</span></td>
<td><code>25</code></td>
<td>Number of threads per Gunicorn worker</td>
</tr>
<tr id="value-accessLogfile" class="value-anchor" data-section="pgadmin-configuration">
<td><code class="value-key">accessLogfile</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>"-"</code></td>
<td>Access log file path (- for stdout, empty to disable)</td>
</tr>
<tr id="value-limitRequestLine" class="value-anchor" data-section="pgadmin-configuration">
...
<tr id="value-serverDefinitions" class="value-anchor" data-section="pgadmin-configuration">
<td><code class="value-key">serverDefinitions</code></td>
<td><span class="type-badge object">object</span></td>
<td><code>{}</code></td>
<td>Pre-configured PostgreSQL server definitions</td>
</tr>
<tr id="value-existingServerDefinitionsConfigMap" class="value-anchor" data-section="pgadmin-configuration">
...
<tr id="value-pgpassFile" class="value-anchor" data-section="pgadmin-configuration">
<td><code class="value-key">pgpassFile</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>""</code></td>
<td>pgpass file content for automatic PostgreSQL authentication</td>
</tr>
<tr id="value-existingPgpassSecret" class="value-anchor" data-section="pgadmin-configuration">
<td><code class="value-key">existingPgpassSecret</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>""</code></td>
<td>Name of an existing Secret containing pgpass file</td>
</tr>
<tr id="value-configLocal" class="value-anchor" data-section="pgadmin-configuration">
<td><code class="value-key">configLocal</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>""</code></td>
<td>Custom config_local.py content for advanced pgAdmin configuration</td>
</tr>
<tr id="value-existingConfigLocalConfigMap" class="value-anchor" data-section="pgadmin-configuration">
...
<tr id="value-smtp" class="value-anchor" data-section="pgadmin-configuration">
<td><code class="value-key">smtp</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>`nil`</code></td>
<td>SMTP/Email configuration for notifications and user management</td>
</tr>
<tr id="value-enabled" class="value-anchor" data-section="pgadmin-configuration">
<td><code class="value-key">enabled</code></td>
<td><span class="type-badge bool">bool</span></td>
<td><code>false</code></td>
<td>Enable SMTP configuration</td>
</tr>
<tr id="value-server" class="value-anchor" data-section="pgadmin-configuration">
<td><code class="value-key">server</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>""</code></td>
<td>SMTP server host</td>
</tr>
<tr id="value-port" class="value-anchor" data-section="pgadmin-configuration">
<td><code class="value-key">port</code></td>
<td><span class="type-badge int">int</span></td>
<td><code>587</code></td>
<td>SMTP server port</td>
</tr>
<tr id="value-useTLS" class="value-anchor" data-section="pgadmin-configuration">
<td><code class="value-key">useTLS</code></td>
<td><span class="type-badge bool">bool</span></td>
<td><code>true</code></td>
<td>Use TLS for SMTP</td>
</tr>
<tr id="value-useSSL" class="value-anchor" data-section="pgadmin-configuration">
<td><code class="value-key">useSSL</code></td>
<td><span class="type-badge bool">bool</span></td>
<td><code>false</code></td>
<td>Use SSL for SMTP</td>
</tr>
<tr id="value-username" class="value-anchor" data-section="pgadmin-configuration">
...
<tr id="value-existingSecretUsernameKey" class="value-anchor" data-section="pgadmin-configuration">
...
<tr id="value-fromAddress" class="value-anchor" data-section="pgadmin-configuration">
<td><code class="value-key">fromAddress</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>"pgadmin@example.com"</code></td>
<td>Email sender address</td>
</tr>
<tr id="value-ldap" class="value-anchor" data-section="pgadmin-configuration">
...
<tr id="value-bindDN" class="value-anchor" data-section="pgadmin-configuration">
<td><code class="value-key">bindDN</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>""</code></td>
<td>LDAP bind DN</td>
</tr>
<tr id="value-bindPassword" class="value-anchor" data-section="pgadmin-configuration">
<td><code class="value-key">bindPassword</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>""</code></td>
<td>LDAP bind password</td>
</tr>
<tr id="value-userBaseDN" class="value-anchor" data-section="pgadmin-configuration">
<td><code class="value-key">userBaseDN</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>""</code></td>
<td>LDAP user base DN</td>
</tr>
<tr id="value-groupBaseDN" class="value-anchor" data-section="pgadmin-configuration">
