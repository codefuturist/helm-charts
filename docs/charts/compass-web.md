...
<div class="filter-buttons">
  <button class="filter-btn" data-section="compass-web-configuration">Compass Web Configuration</button>
...
<tbody>
<tr class="values-section-header"><td colspan="4"><strong>Compass Web Configuration</strong></td></tr>
<tr id="value-mongoUri" class="value-anchor" data-section="compass-web-configuration">
...
<tr id="value-existingSecret" class="value-anchor" data-section="compass-web-configuration">
<td><code class="value-key">existingSecret</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>""</code></td>
<td>Name of an existing secret containing MongoDB connection string</td>
</tr>
<tr id="value-existingSecretKey" class="value-anchor" data-section="compass-web-configuration">
...
<tr id="value-appName" class="value-anchor" data-section="compass-web-configuration">
<td><code class="value-key">appName</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>"Compass Web"</code></td>
<td>Application name displayed in the UI</td>
</tr>
<tr id="value-orgId" class="value-anchor" data-section="compass-web-configuration">
<td><code class="value-key">orgId</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>"default-org-id"</code></td>
<td>Organization ID associated with the connection</td>
</tr>
<tr id="value-projectId" class="value-anchor" data-section="compass-web-configuration">
...
<tr id="value-clusterId" class="value-anchor" data-section="compass-web-configuration">
...
<tr id="value-basicAuth" class="value-anchor" data-section="compass-web-configuration">
<td><code class="value-key">basicAuth</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>`nil`</code></td>
<td>Basic HTTP authentication configuration</td>
</tr>
<tr id="value-enabled" class="value-anchor" data-section="compass-web-configuration">
<td><code class="value-key">enabled</code></td>
<td><span class="type-badge bool">bool</span></td>
<td><code>false</code></td>
<td>Enable basic authentication</td>
</tr>
<tr id="value-username" class="value-anchor" data-section="compass-web-configuration">
<td><code class="value-key">username</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>""</code></td>
<td>Username for basic auth</td>
</tr>
<tr id="value-password" class="value-anchor" data-section="compass-web-configuration">
...
<tr id="value-existingSecretUsernameKey" class="value-anchor" data-section="compass-web-configuration">
<td><code class="value-key">existingSecretUsernameKey</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>"username"</code></td>
<td>Key in existingSecret for username</td>
</tr>
<tr id="value-existingSecretPasswordKey" class="value-anchor" data-section="compass-web-configuration">
<td><code class="value-key">existingSecretPasswordKey</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>"password"</code></td>
<td>Key in existingSecret for password</td>
</tr>
<tr id="value-genAI" class="value-anchor" data-section="compass-web-configuration">
...
<tr id="value-apiKey" class="value-anchor" data-section="compass-web-configuration">
...
<tr id="value-model" class="value-anchor" data-section="compass-web-configuration">
<td><code class="value-key">model</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>"gpt-4o-mini"</code></td>
<td>OpenAI model to use</td>
</tr>
<tr id="value-enableSampleDocuments" class="value-anchor" data-section="compass-web-configuration">
<td><code class="value-key">enableSampleDocuments</code></td>
<td><span class="type-badge bool">bool</span></td>
<td><code>false</code></td>
<td>Enable uploading sample documents to GenAI service</td>
</tr>
<tr id="value-querySystemPrompt" class="value-anchor" data-section="compass-web-configuration">
<td><code class="value-key">querySystemPrompt</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>""</code></td>
<td>Custom system prompt for query generation</td>
</tr>
<tr id="value-aggregationSystemPrompt" class="value-anchor" data-section="compass-web-configuration">
<td><code class="value-key">aggregationSystemPrompt</code></td>
<td><span class="type-badge string">string</span></td>
<td><code>""</code></td>
<td>Custom system prompt for aggregation generation</td>
</tr>
<tr id="value-config" class="value-anchor" data-section="compass-web-configuration">
