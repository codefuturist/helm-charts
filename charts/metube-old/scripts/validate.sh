#!/usr/bin/env bash
# Quick validation script for pgAdmin chart

set -e

CHART_DIR="/Users/colin/Developer/Projects/personal/helm-charts/charts/pgadmin"

echo "Testing pgAdmin Helm Chart..."
echo ""
...
RESOURCES=$(helm template test "$CHART_DIR" \
  --set pgadmin.email=admin@example.com \
  --set pgadmin.password=test123 | grep "^kind:" | wc -l)
