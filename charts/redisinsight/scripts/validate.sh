#!/usr/bin/env bash
# Quick validation script for RedisInsight chart

set -e

CHART_DIR="/Users/colin/Developer/Projects/personal/helm-charts/charts/redisinsight"

echo "Testing RedisInsight Helm Chart..."
echo ""
...
RESOURCES=$(helm template test "$CHART_DIR" \
  --set redisinsight.email=admin@example.com \
  --set redisinsight.password=test123 | grep "^kind:" | wc -l)
