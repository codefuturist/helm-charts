#!/bin/bash
# Installation script for Uptime Kuma Helm chart to k3s-development-k3s-testbox

set -e

CHART_PATH="/Users/colin/Developer/Projects/personal/helm-charts/charts/uptime-kuma"
...
echo "==================================================================="
echo "Uptime Kuma Helm Chart Installation"
echo "==================================================================="
echo ""
