# RedisInsight Chart CI Tests

This directory contains CI test configurations for the RedisInsight Helm chart. These tests are automatically run by Chart Testing (ct) to validate the chart before release.
