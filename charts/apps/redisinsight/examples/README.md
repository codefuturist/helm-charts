...
```bash
helm install my-redisinsight codefuturist/redisinsight -f values-minimal.yaml
```
...
```bash
helm install my-redisinsight codefuturist/redisinsight -f values-with-persistence.yaml
```
...
```bash
helm install my-redisinsight codefuturist/redisinsight -f values-multiple-servers.yaml
```
